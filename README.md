# spring-with-quarkus-for-load-test Project
...
You can then execute your native executable with: `./target/spring-with-quarkus-for-load-test-1.0.0-SNAPSHOT-runner`
